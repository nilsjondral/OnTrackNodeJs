...
// app.get('/flights/:from-:to', function(req, res) { // http://localhost:5000/flights/LAX-SFO
//   res.send(req.params); // { "from": "LAX", "to": "SFO" }
// });

// // 6 http://localhost:5000/handlers
// // route handlers
...
// // 8 http://localhost:5000/kittens http://localhost:5000/kitten
// // router
